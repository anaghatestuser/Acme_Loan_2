...
class SchedulingAgent(AcmeLoanAgentFramework):
    ...
    async def call_agent_model(self, user_message: str, meeting_reference: str) -> str:
        ...
        # LINEAJE: enforce() `_lineaje_messages` at user_interface->agent post_agent_receive — scan flagged AI_APP_SEC_059 (Do not allow prompts that can execute malicious commands at runtime.). Mask/block; do not remove without review. site_id='site:sha256:0b19961cb7c7cc41120794f8bec1b44a1063e5fea13ebc0f3486f0af7d845c97'
        _gr_client = _lineaje_load_gr_client()
        _gr_site = _gr_client.SiteDescriptor(site_id='site:sha256:0b19961cb7c7cc41120794f8bec1b44a1063e5fea13ebc0f3486f0af7d845c97', phase='post_agent_receive', boundary={'source': 'user_interface', 'sink': 'agent_message'}, candidate_policies=[], fail_mode='ALLOW_WITH_AUDIT', source_type='user_interface', destination_type='agent')
